...
def model_prediction(test_image):
    model = tf.keras.models.load_model(
        r"D:\Tensorflow Working\Plant2\trained_plant_disease_model.keras"
    )
...
def predict_fertilizer(temparature, humidity, moisture, nitrogen, potassium, phosphorous, soil_type, crop_type):
    ...
    with open(r"D:\Tensorflow Working\Plant2\fertikizer.pkl", "rb") as f:
        model = pickle.load(f)
    with open(r"D:\Tensorflow Working\Plant2\label_encoder.pkl", "rb") as f:
        le = pickle.load(f)
...
def crop_prediction(a, b, c, d, e, f, g):
    try:
        with open(r"D:\Tensorflow Working\Plant2\Navis_Base.pkl", "rb") as file:
...
if app_mode == "🏡 Home":
    ...
    img = Image.open(r"D:\Tensorflow Working\Plant2\image.png")
                    ...
                    with st.spinner("Analyzing your crop..."):
                        ...
                        st.markdown(
                            ...
                            <div style='background-color:#E6FFE6; padding:20px; border-radius:10px;'>
                                ...
                                <p style='font-size:20px;'><b>{disease.replace('_', ' ')}</b></p>
